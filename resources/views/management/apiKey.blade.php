    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Thông tin tài khoản Key Api</h4>
                </div>
                <div class="pb-20">
                        ...
                        <tbody>
                            ...
                            @foreach ($keyapi as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->abilities == "unactivate")
                                            {{ "Hủy kích hoạt" }}
                                        @elseif ($item->abilities == "activate")
                                            {{ "Kích hoạt" }}
                                        @else
                                            {{ "" }}
                                        @endif
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a
                                                    ...
                                                    class="dropdown-item"
                                                    data-toggle="modal"
                                                    data-target="#edit-key-api"
                                                    type="button"
                                                >
                                                    <i class="dw dw-edit2"></i> Sửa tài khoản API
                                                </a>
                                                <a class="dropdown-item" href="{{route('manager.delete.token',['token' => $item->_id])}}"><i class="dw dw-delete-3"></i> Xóa tài khoản API</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr> 
                                @include('management.modal.key_api.edit')
                            @endforeach    
                            @endif 
                        </tbody>
                    </table>
...
<!-- modals-->
@include('management.modal.key_api.create')
