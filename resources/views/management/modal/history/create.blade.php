...
>
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="create_history" method="POST" action="{{ route('manager.history.store') }}">
                @csrf
                <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <label class="col-form-label">Mã diễn viên</label>
                                <input id="person_id" type="number" class="form-control" name="person_id" value=""/>
                                <div class="form-control-feedback validate_person_id"></div>
                            </div>
                            <div class="col-sm-6 col-md-6">
    ...
    function createHistory() { 
        $.ajax({
            ...
            data:{
                ...
                'person_id': $('input[name=person_id]')[0].value,
                'media_type': $('select[name=media_type]')[0].value,
                'user_id': $('select[name=user_id]')[0].value,
            },
            url: "{{ route('manager.create.history.request') }}",
            success: function (response) {
                if (response.status === "error") {
                    ...
                    $('form[id=create_history]')[0].submit();   
                }
